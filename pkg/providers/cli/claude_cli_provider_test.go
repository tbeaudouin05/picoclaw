...
func TestBuildSystemPrompt_AdvertisedCronRequiresFinalJSONTextProtocol(t *testing.T) {
	...
	for _, want := range []string{
		...
		"exactly one JSON object with a tool_calls field",
		"final non-whitespace content; prose is allowed only before it",
		"Markdown fences, inline backticks, or quotation marks",
		"Never show JSON unless you are actually calling a tool",

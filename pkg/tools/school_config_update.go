...
func NewSchoolConfigUpdateTool(store SchoolConfigStore, configID string, adminChannels []string) *SchoolConfigUpdateTool {
	...
	return &SchoolConfigUpdateTool{store: store, configID: configID, adminChannels: allowed}
}
